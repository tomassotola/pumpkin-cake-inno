...
export function Stats(_ref) {
  ...
  process.env.NODE_ENV === 'development' ? warn(!(translations !== null && translations !== void 0 && translations.stats), 'The `stats` translation is deprecated. Please use `rootElementText` instead.') : void 0;
